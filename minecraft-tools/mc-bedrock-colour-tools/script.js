...
//bold
text = text.replace(/§l/gi,"<span style='font-family: Minecraft; font-weight:900;'>");
//italic
text = text.replace(/§o/gi,"<span style='font-family: Minecraft; font-style:italic;'>");
//strikethrough
...
//obfuscated
text = text.replace(/§k/gi,"<span style='font-family: Minecraft;' class='obfuscated'>");
//reset
...
function randomizer(rawr) {
    ...
    var text = '';
    var possible = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzАаБбВвГгДдЕеЁёЖжЗзИиЙйКкЛлМмНнОоПпРрСсТтУуФфХхЦцЧчШшЩщЪъЫыЬьЭэЮюЯя123456789";
